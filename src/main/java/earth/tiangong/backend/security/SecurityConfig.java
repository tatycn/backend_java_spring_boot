package earth.tiangong.backend.security;
...
import earth.tiangong.backend.security.filter.JwtAuthenticationTokenFilter;
import earth.tiangong.backend.security.impl.AuthenticationEntryPointImpl;
import earth.tiangong.backend.security.impl.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .antMatchers("/home/ok", "/user/login", "/user/register", "/user/register/getCode/**", "/user/resetPassword", "/user/resetPassword/getCode/**", "/user/checkApiLoginCode/**/**")
                .anonymous()
                // 静态资源，可匿名访问
