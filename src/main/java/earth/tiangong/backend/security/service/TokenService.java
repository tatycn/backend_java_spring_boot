...
import earth.tiangong.backend.security.util.IdUtils;
...
public class TokenService {
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            try {
                ...
                User user = iUserService.getByTokenKey(uuid);
    ...
    public void delLoginUser(String token) {
        if (StringUtils.isNotEmpty(token)) {
            iUserService.deleteTokenKey(token);
        }
    }
    ...
    public String createToken(LoginUser loginUser) {
        ...
        iUserService.updateTokenKey(loginUser.getUserId(), loginUser.getToken());
    ...
    public void refreshToken(LoginUser loginUser) {
        ...
        iUserService.updateTokenExpireTime(loginUser.getToken(), new Timestamp(tokenExpireTime));
    }
